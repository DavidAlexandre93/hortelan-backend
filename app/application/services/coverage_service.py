...
PRODUCT_MODULES: list[dict[str, object]] = [
    ...
    },
    {
        ...
        'implemented': False,
        'existing_endpoints': [
            '/api/v1/devices/{device_id}/snapshot',
    ...
    },
    {
        ...
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem endpoints sociais/comunidade.',
    },
    {
        'slug': 'templates-cultivo-automacao',
        'title': 'Templates de cultivo/automação',
        'stage': 'V2',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem catálogo de templates aplicáveis.',
    },
    {
        ...
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem relatórios especializados/exportações avançadas.',
    },
    {
        'slug': 'clima-regras-clima',
        'title': 'Clima e regras com clima',
        'stage': 'V2',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Integração meteorológica e regras climáticas não implementadas.',
    },
    {
        'slug': 'multiusuario-permissoes',
        'title': 'Multiusuário/permissões',
        'stage': 'V2',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem RBAC e compartilhamento de hortas.',
    },
    {
        ...
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Não existe central/política de notificações avançadas.',
    },
    {
        'slug': 'backoffice-robusto',
        'title': 'Backoffice robusto',
        'stage': 'V2',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem APIs administrativas dedicadas.',
    },
    {
        'slug': 'diagnostico-por-foto',
        'title': 'Diagnóstico por foto',
        'stage': 'V3',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Não há inferência/computer vision integrado.',
    },
    {
        'slug': 'assistente-inteligente',
        'title': 'Assistente inteligente',
        'stage': 'V3',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem endpoint de assistente conversacional/recomendações inteligentes.',
    },
    {
        ...
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem catálogo/carrinho/checkout no backend.',
    },
    {
        'slug': 'recompensas-gamificacao-avancadas',
        'title': 'Recompensas/gamificação avançadas',
        'stage': 'V3',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem regras de pontos, badges e desafios.',
    },
    {
        'slug': 'b2b-b2g',
        'title': 'B2B/B2G',
        ...
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Sem módulos corporativos/institucionais.',
    },
    {
        'slug': 'modo-local-offline',
        'title': 'Modo local/offline para confiança operacional (se aplicável ao hardware)',
        'stage': 'V3',
        'status': 'não atende',
        'implemented': False,
        'existing_endpoints': [],
        'notes': 'Não há estratégia offline exposta via API para operação desconectada.',
    },
]
...
def _build_product_module_detail(module: dict[str, object]) -> ProductModuleCoverageOut:
    ...
    return ProductModuleCoverageOut(
        ...
        existing_endpoints=list(cast(list[str], module['existing_endpoints'])),
...
class CoverageService:
    def list_requirement_coverage(self) -> list[RequirementCoverageOut]:
        return [
            RequirementCoverageOut(
                requirement_id=requirement_id,
                title=title,
    ...
    def strategic_coverage_report(self) -> StrategicCoverageReportOut:
    ...
    def product_readiness_report(self) -> ProductReadinessReportOut:
    ...
    def product_module_detail(self, module_slug: str) -> ProductModuleCoverageOut:
    ...
    def requirement_detail(self, requirement_id: str, title: str) -> RequirementDetailOut:
